class DiceRoller {
  ...
  constructor(commandProcessor){
    commandProcessor.register("roll", this.normalRoll.bind(this));
    commandProcessor.register("dice", this.normalRoll.bind(this));
    commandProcessor.register("sroll", this.specialityRoll.bind(this));
    commandProcessor.register("droll", this.soakOrDamageRoll.bind(this));
    commandProcessor.register("soak", this.soakOrDamageRoll.bind(this));
  }
  ...
  countSuccesses(results, difficulty, speciality=false){
    return results.reduce((count, result) => {
      return count + ((result >= difficulty) ? 1 : 0)
    }, 0);
  }
